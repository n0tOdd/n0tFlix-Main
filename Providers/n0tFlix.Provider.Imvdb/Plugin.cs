...
using n0tFlix.Provider.Imvdb.Configuration;
using System;
...
namespace n0tFlix.Provider.Imvdb
{
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        ...
        /// </summary>
        public override string Description => "A metadata provider for imvdb to get data about your music videos";
        ...
        /// </summary>
        public override Guid Id => Guid.Parse("1bd29ee2-24aa-4774-a0ed-46fd0204a11a");
