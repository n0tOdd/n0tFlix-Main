...
using n0tFlix.Channel.ComedyCentral.Configuration;
using System;
...
namespace n0tFlix.Channel.ComedyCentral
{
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        ...
        /// </summary>
        public override Guid Id => Guid.Parse("f8d6e3ed-54bf-4d2e-b2c3-250e42c13002");
        ...
        public IEnumerable<PluginPageInfo> GetPages()
        {
            ...
            pluginPageInfos.Add(new PluginPageInfo()
            {
                ...
                MenuSection = "n0tFlix",//<== create my own part of the meny, slowly im taking over all the jellyfin and n0tflix is born :P
