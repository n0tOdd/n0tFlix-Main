...
using n0tFlix.Channel.Crunchyroll.Configuration;
using System;
...
namespace n0tFlix.Channel.Crunchyroll
{
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        ...
        /// </summary>
        public override string Description => "A channel that lets you watch most of the content from " + GetType().Namespace.Split(".").Last();
        ...
        /// </summary>
        public override Guid Id => Guid.Parse("eef1f71b-340f-4099-af64-5c5e0d277e87");
        ...
        public IEnumerable<PluginPageInfo> GetPages()
        {
            ...
            pluginPageInfos.Add(new PluginPageInfo()
            {
                ...
                EnableInMainMenu = true, //<== this makes it show up on youre dashboard menu, i was hoping public menu
                MenuIcon = "",
            });
