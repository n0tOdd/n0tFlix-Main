...
namespace n0tFlix.Channel.NRK
{
    public class Channel : IChannel, IRequiresMediaInfoCallback, ISupportsLatestMedia, ISupportsMediaProbe, ISearchEngine
    {
        ...
        public Channel(ILogger<Channel> logger, IMemoryCache memoryCache, ISearchEngine _searchEngine)
        {
        ...
        public async Task<IEnumerable<MediaSourceInfo>> GetChannelItemMediaInfo(string id, CancellationToken cancellationToken)
         => await worker.GetMediaSourceInfo(id, logger, cancellationToken);
        ...
        public QueryResult<SearchHintInfo> GetSearchHints(SearchQuery query)
        {
            ...
            searchHintInfo.Item.Name = "batman";
            searchHintInfo.Item.Id = Guid.NewGuid();
            searchHintInfo.MatchedTerm = "batman";

            List<SearchHintInfo> ss = new List<SearchHintInfo>() { searchHintInfo };
