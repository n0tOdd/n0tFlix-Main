...
namespace n0tFlix.Channel.NRK
{
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        ...
        /// </summary>
        public override string Description => "A channel that lets you watch the content awailable on nrk web tv";
        ...
        /// </summary>
        public override Guid Id => Guid.Parse("7ae457ca-a5cf-4f78-97f5-b6e5f12511f6");
