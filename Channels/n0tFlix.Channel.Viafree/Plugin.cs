...
namespace n0tFlix.Channel.Viafree
{
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        ...
        /// </summary>
        public override string Description => "A channel that brings you all the content awailable from viafree";
        ...
        /// </summary>
        public override Guid Id => Guid.Parse("839c802f-ca0c-4785-ae61-e7a7a50689c7");
        ...
        public override PluginInfo GetPluginInfo()
        {
            return new PluginInfo()
            {
                ...
                Version = "1.0.0.4",//Remember to increase every tim you want the ManifestManager to update youre plugin
            };
        }
