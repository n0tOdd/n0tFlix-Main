...
{
    public static class mediafeed_series_by_X_Results
    {
        //https://viafree-content.mtg-api.com/viafree-content/v1/no/block/mediaFeed_series-by-channel/viasat-4?device=web
        public static string URL_Channel = "https://viafree-content.mtg-api.com/viafree-content/v1/{0}/block/mediaFeed_series-by-channel/{1}?device=web";

        public static string URL_Category = "https://viafree-content.mtg-api.com/viafree-content/v1/{0}/block/mediaFeed_series-by-category/{1}?device=web";
        ...
        /// <summary>
        /// public path not used here, needs countrycode and a valid channel name
        /// </summary>
        /// <param name="UsePulicPath"></param>
        /// <param name="CountryCode"></param>
        /// <param name="Path"></param>
        /// <returns>Returns all the latest episodes </returns>
        public static async Task<root> GetRootAsCategory(bool UsePulicPath = false, string CountryCode = "no", string Path = "dokumentar")
        {
            WebClient client = new WebClient();

            string json = await client.DownloadStringTaskAsync(String.Format(URL_Category, CountryCode, Path));
        ...
        public static async Task<root> GetRootAsChannel(bool UsePulicPath = true, string CountryCode = "no", string Path = "viasat-4")
        {
            WebClient client = new WebClient();

            string json = await client.DownloadStringTaskAsync(String.Format(URL_Channel, CountryCode, Path));
            if (string.IsNullOrEmpty(json))
            {
                return null;
            }
