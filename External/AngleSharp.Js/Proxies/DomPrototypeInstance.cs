namespace AngleSharp.Js
{
    ...
    internal sealed class DomPrototypeInstance : ObjectInstance
    {
            ...
            : base(engine.Jint)
        {
            ...
            SetPrototypeOf(engine.GetDomPrototype(baseType));
        }

        public String Class => _name;
        ...
        private void SetEvent(String name, MethodInfo adder, MethodInfo remover)
        {
            ...
            FastSetProperty(name, new PropertyDescriptor(eventInstance.Getter, true, false, false));
            FastSetProperty(name, new PropertyDescriptor(eventInstance.Setter, true, false, false));
        }
