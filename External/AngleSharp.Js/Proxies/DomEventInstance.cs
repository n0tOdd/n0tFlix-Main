namespace AngleSharp.Js
{
    ...
    internal sealed class DomEventInstance
    {
        ...
        public DomEventInstance(EngineInstance engine, MethodInfo addHandler, MethodInfo removeHandler)
        {
            ...
            Getter = new ClrFunctionInstance(engine.Jint, nameof(GetEventHandler), GetEventHandler);
            Setter = new ClrFunctionInstance(engine.Jint, nameof(SetEventHandler), SetEventHandler);
        }
        ...
        private JsValue SetEventHandler(JsValue thisObject, JsValue[] arguments)
        {
            ...
            if (node != null)
            {
                ...
                if (arguments[0].GetType() == typeof(FunctionInstance))
                {
