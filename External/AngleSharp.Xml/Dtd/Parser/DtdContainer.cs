namespace AngleSharp.Xml.Dtd.Parser
{
    ...
    sealed class DtdContainer : ICollection<Node>
    {
        ...
        private readonly Bin<Notation> _notations;
        private readonly Bin<Entity> _entities;
        private readonly Bin<Entity> _parameters;
        private readonly Bin<AttributeDeclaration> _attributes;
        private readonly Bin<ElementDeclaration> _elements;
        private readonly List<Node> _nodes;
        private readonly DtdContainer _parent;
        private readonly List<DtdContainer> _children;
        private String _url;
        ...
        sealed class Bin<T> : IEnumerable<T>
            where T : Node
        {
            private readonly DtdContainer _container;
            private readonly List<T> _list;
            private readonly Boolean _unique;
            private readonly Func<T, String> _select;
