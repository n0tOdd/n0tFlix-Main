...
namespace n0tFlix.Subtitles.NapiSub.SubtitlesParser.Parsers
{
    /// <summary>
    ...
    public class SubViewerParser : ISubtitlesParser
    {
        ...
        private readonly Regex _timestampRegex = new Regex(@"\d{2}:\d{2}:\d{2}\.\d{2},\d{2}:\d{2}:\d{2}\.\d{2}");
        ...
        private ParseTimecode ParseTimecodeLine(string line)
        {
