...
namespace n0tFlix.Subtitles.Yify
{
    public class YifyDownloader : ISubtitleProvider
    {
        ...
        public YifyDownloader(ILogger<YifyDownloader> logger, IHttpClient httpClient, IServerConfigurationManager config, IJsonSerializer json, IFileSystem fileSystem, ILocalizationManager localizationManager)
        {
            _logger = logger;
